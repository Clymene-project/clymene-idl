...
proto-metric:
	...
	protoc -I=./github.com/gogo/protobuf -I=./prompb -I=./googleapis -I=. --gofast_out=plugins=grpc:output --grpc-gateway_out=logtostderr=true:output/prompb prompb/rpc.proto
